...
const Form = ({children, setOpenForm, setOpenLogin}) => {
    ...
    const PageDisplay = () => {
        ...
        if (page === 2) {
            return <OneLastStep registerProfile={registerProfile} setOpenForm={setOpenForm} setOpenLogin={setOpenLogin} formData={formData} setFormData={setFormData} page={setPage}/>
        }
    }
